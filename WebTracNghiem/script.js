...
function displayAllQuestions() {
  ...
  console.log("Kiểu dữ liệu quizData:", typeof quizData);
  console.log("Có phải mảng không?", Array.isArray(quizData));
  console.log("Nội dung quizData:", quizData);
  ...
  lastQuizResult.quizData.forEach((questionData, index) => {
    ...
    if (questionData.type === "fillInBlank") {
      ...
      answerElement.innerHTML = `
        <p>Câu trả lời của bạn: <span class="${isCorrect ? "correct" : "incorrect"
        }">${userAnswer}</span></p>
        <p>Đáp án đúng: <span class="correct">${questionData.correctAnswer
        }</span></p>
      `;
